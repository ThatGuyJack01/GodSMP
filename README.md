# Notice 
I DID NOT WRITE THE BASE CODE FOR THIS. Nevertheless, 95% of this is mine. This is a fork of the [Origins Mod](https://github.com/apace100/origins-fabric). This is a standalone mod and does not require an additional version of origins (although it should be compatible with origin extension mods in theory.)
